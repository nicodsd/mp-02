    ...
    <div className="min-h-screen font-sans flex flex-col relative selection:bg-secondary selection:text-primary overflow-x-hidden">
        ...
        <div className="w-full bg-card-light py-8 rounded-3xl border border-gray-500 pt-16 relative transition-colors duration-200 mt-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="mt-2 text-center">
              ...
              <Link className="block text-blue-600 font-bold hover:underline text-sm" href="/registro-de-usuario">
                Registrarse
              </Link>
            </div>
          </form>
      ...
      <footer className="w-full h-fit flex flex-col items-center justify-between bg-primary space-y-5 py-3">
        <div className="flex items-center justify-center space-x-6">
          ...
          <button type="button" className="text-white text-xs uppercase font-black p-3 w-35 bg-black rounded-lg">Haste premium</button>
        </div>
        <div className="text-center text-xs text-white">
          <p>© {new Date().getFullYear()} QMenu. Todos los derechos reservados.</p>
          <p>Por <a className="font-bold" href="https://github.com/nicobarrera" target="_blank" rel="noopener noreferrer">Nico Barrera</a></p>
        </div>
      </footer>
    </div>
  );
