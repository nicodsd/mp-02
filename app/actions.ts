...
export async function activateRestaurantSubscription(data: { status: string, qMenuId?: string, email?: string, transactionId?: number | string, preapprovalId?: string | number }) {
