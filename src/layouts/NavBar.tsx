...
export default function NavBar({
  ...
  return (
    <header className="flex flex-col w-full">
      ...
      <div
        className={`relative w-full bg-linear-to-t from-primary/90 via-orange-300/90 to-background transition-all ${isSpecialState ? "h-14" : "h-80"} flex items-center bg-center bg-cover bg-no-repeat`}
        style={inlineStyle}
      >
        {!isSpecialState && (
          <div
