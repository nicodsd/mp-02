...
export const ConfigOptionCard: React.FC<ConfigOptionCardProps> = ({ id, label, selected, onSelect, children, format }) => {
    ...
    return (
        ...
        >
            <div className={`relative ${isVertical ? 'flex-col items-center justify-between min-h-35 w-full' : 'flex-row items-center justify-between h-24'} flex-1 border-2 rounded-2xl py-3 px-4 flex bg-white transition-all duration-300 
