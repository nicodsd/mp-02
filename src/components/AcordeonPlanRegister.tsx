    ...
    const plans = [
        ...
        },
        {
            ...
            features: [
                ...
                "Sección para gestión de pedidos",
                "Multi sucursal",
                "Agrega promociones",
                "Soporte prioritario"
            ],
                            ...
                            >
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <div className={`h-6 w-6 rounded-md border-2 flex items-center justify-center transition-all ${plan.id === 'free' ? 'border-stone-400' : 'border-white'
                                    ...
                                    <Field type="radio" name="plan" value={plan.id} className="hidden" />
                                </button>
