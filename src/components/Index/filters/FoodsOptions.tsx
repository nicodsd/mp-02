            ...
            <div className="flex flex-wrap justify-center gap-1 w-full">
                {availableCategories.map((option, index) => (
                    <div
                        ...
                        key={index}
                        className={`flex border px-5 mt-1 mb-1 border-gray-300 flex-col w-[24%] h-25 cursor-pointer items-center justify-center hover:bg-gray-50 rounded-2xl transition-colors duration-200 ${selectedCategory === option.name
