...
export default function Navbar({ isIndex }: { isIndex: boolean }) {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all border-b  duration-300 ${scrolled
      ? 'shadow-md md:shadow-none border-gray-300/50 bg-background/40 backdrop-blur-md'
