...
export default function Hero() {
  return (
    <div id="inicio" className="relative border-b border-bone-300 w-full pt-26 pb-16 lg:pt-50 lg:pb-20 overflow-hidden">
      <div className="relative flex flex-col md:flex-row md:grid md:grid-cols-2 items-center md:items-end justify-between z-10">
        ...
        <div className="text-start w-full flex md:pb-5 flex-col items-start">
          <Image
            src={HeroImage}
            alt="Hero Image"
          ...
          <h1 className="text-6xl font-extrabold text-[#B10000] tracking-tight leading-none mb-6 md:mb-8">
            tu menú
            <br className="block" />
            en el móvil
            <br className="block" />
            <span className='text-6xl leading-none md:text-6xl font-black' style={{
              lineHeight: "1.1",
          ...
          <p className="max-w-2xl text-base md:text-lg text-stone-600 leading-relaxed font-medium mb-8 md:mb-10">
        ...
        <div className="h-full w-full flex items-center justify-end">
          <Image
            src={HeroImage}
            alt="Hero Image"
            className="w-auto hidden md:block h-100"
            width={1920}
            height={1080}
            priority
          />
