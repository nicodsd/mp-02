  ...
  return (
    <div id="inicio" className="relative w-full pt-30 md:pt-50 pb-30 overflow-hidden">
      <div className="relative flex flex-col md:flex-row md:grid md:grid-cols-2 items-center md:items-end justify-between z-10">
        ...
        <div className="text-center md:text-start w-full z-10 flex md:pb-5 md:ml-8 flex-col md:items-start items-center md:justify-start">
          ...
          <motion.h1 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="text-[3rem] md:text-6xl font-extrabold leading-none text-primary mb-4 md:mb-8">
            Tu menú digital rápido, gratis
            <br className="block" />
            <span className='text-red-900 font-black'>y con QR para tu restaurante</span>
          </motion.h1>
