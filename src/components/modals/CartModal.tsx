...
export default function CartModal({ user, isOpen, onClose, template }: CartModalProps) {
    ...
    // Filtrado correcto garantizando IDs alineados como Strings
    const selectedFoods = foods.filter((food: any) => selectedIds.includes(String(food._id)));

    // Cálculo total de ítems reales en el carrito en base a sus cantidades acumuladas
    ...
    const handleEncargar = () => {
        ...
        // Validación básica antes de mandar a WhatsApp si es envío a domicilio
