...
const SortPriceButton = ({ onSortChange }: SortPriceButtonProps) => {
    ...
    return (
        <button
            ...
            className="w-[15%] h-8 border border-gray-400 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none flex items-center justify-center gap-2"
        >
